...
//
//				MXTsend.dat.pos.w.x += (tgtPose.w.x * ratio);
//				MXTsend.dat.pos.w.x += (tgtPose.w.y * ratio);
//				MXTsend.dat.pos.w.x += (tgtPose.w.z * ratio);
//				MXTsend.dat.pos.w.x += (tgtPose.w.a * ratio);
//				MXTsend.dat.pos.w.x += (tgtPose.w.b * ratio);
//				MXTsend.dat.pos.w.x += (tgtPose.w.c * ratio);
//
//				break;
//			case MXT_TYP_PULSE:
...
//						sprintf(buf, "Receive (%ld): TCount=%dType(PULSE / OTHER) = % d¥n % ld, % ld, % ld, % ld, % ld, % ld, % ld, % ld(% s)"
//							, MXTrecv.CCount, MXTrecv.TCount, DispType
